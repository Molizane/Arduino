...
void loop() {
  if (targetTime < millis()) {
    ...
    if (ss==0 || initial) {
      ...
      tft.setTextColor(0xF81F, ILI9340_BLACK); // Pink
    ...
    if (omm != mm) { // Only redraw every minute to minimise flicker
      ...
      tft.setTextColor(0x39C4, ILI9340_BLACK);  // Leave a 7 segment ghost image, comment out next line!
      //tft.setTextColor(ILI9340_BLACK, ILI9340_BLACK); // Set font colour to back to wipe image
    ...
    if (ss%2) { // Flash the colon
      tft.setTextColor(0x39C4, ILI9340_BLACK);
      xpos+= tft.drawChar(':',xcolon,ypos,7);
      tft.setTextColor(0xFBE0, ILI9340_BLACK);
      ...
      tft.fillRect (0, 74, 240, 20, ILI9340_BLACK);
