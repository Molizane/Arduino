...
void rotateFillcircle(void) {
  Serial.println("rotateFillcircle");
  tft.fillScreen(BLACK);
...
void rotateDrawcircle(void) {
  Serial.println("rotateDrawcircle");
  tft.fillScreen(BLACK);
